...
public class JobManage {
	...
	private static String JOB_GROUP_NAME = "JOB_GROUP_NAME1";
	private static String TRIGGER_GROUP_NAME = "TRIGGER_GROUP_NAME1";
...
//		resumeJob();
	...
	public static void startSchedule() {
		try {
			...
			JobDetail jobDetail = JobBuilder.newJob(JobCon1.class)
					// 任务执行类
